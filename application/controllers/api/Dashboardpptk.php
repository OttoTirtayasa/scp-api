<?php
  ...
  class Dashboardpptk extends REST_Controller {
    ...
    public function index_get(){
        ...
        // paket all
        $query1 = "SELECT COUNT(a.pa_id) paket_all FROM sc_paket a WHERE a.pptk_id = $pptk_id and a.status = 0";
    ...
    public function paketall_get(){
      $pptk_id = $this->get('pptk_id');
      $query = "SELECT COUNT(a.pa_id) paket_all FROM sc_paket a WHERE a.pptk_id = $pptk_id and a.status = 0";
